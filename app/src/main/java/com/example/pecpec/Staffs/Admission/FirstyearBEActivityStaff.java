...
public class FirstyearBEActivityStaff extends AppCompatActivity {
    ...
    //Intilazie
    private AdmissionFirstBEAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_firstyear_bestaff);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    mechDept.setLayoutManager(new LinearLayoutManager(FirstyearBEActivityStaff.this));
                    adapter = new AdmissionFirstBEAdapter(list1,FirstyearBEActivityStaff.this,"Mechanical Engineering");
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(FirstyearBEActivityStaff.this,error.getMessage() , Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()) {
                    ...
                    civilDept.setLayoutManager(new LinearLayoutManager(FirstyearBEActivityStaff.this));
                    adapter = new AdmissionFirstBEAdapter(list2, FirstyearBEActivityStaff.this, "Civil Engineering");
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    cseDept.setLayoutManager(new LinearLayoutManager(FirstyearBEActivityStaff.this));
                    adapter = new AdmissionFirstBEAdapter(list3,FirstyearBEActivityStaff.this,"Computer Science Engineering");
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    eceDept.setLayoutManager(new LinearLayoutManager(FirstyearBEActivityStaff.this));
                    adapter = new AdmissionFirstBEAdapter(list4,FirstyearBEActivityStaff.this,"ECE");
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()) {
                    ...
                    eeeDept.setLayoutManager(new LinearLayoutManager(FirstyearBEActivityStaff.this));
                    adapter = new AdmissionFirstBEAdapter(list5, FirstyearBEActivityStaff.this, "EEE");
