    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        First_Year_BE.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AdmissionActivity.this, FirstyearBEActivityStaff.class);
        ...
        Lateral_Entry_BE.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AdmissionActivity.this, LateralEnterBEActivity1Staff.class);
                startActivity(intent);
            }
        });
        ME.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AdmissionActivity.this, MEActivityStaff.class);
                startActivity(intent);
            }
        });
        MBA_MCA.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AdmissionActivity.this, MCAMBAActivityStaff.class);
                startActivity(intent);
            }
        });
    }
