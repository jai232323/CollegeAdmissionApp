...
public class MEAdapter extends RecyclerView.Adapter<MEAdapter.ViewHolder> {
    ...
    public MEAdapter(List<AdmissionStaffData> list, Context context, String category) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.me_adapter,parent,false);

        return new MEAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull MEAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
    ...
    private void pushData(MEAdapter.ViewHolder holder, int position) {
        pd=new ProgressDialog(context);
        AdmissionStaffData item = list.get(position);
...
//        final String uniqueKey = dbRef.push().getKey();
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().
                getReference("ME Admission Forms Staff Verified").child(item.getUserIDUniqueKey());
