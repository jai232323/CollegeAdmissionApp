...
public class NavMCAMBAAdapteer extends RecyclerView.Adapter<NavMCAMBAAdapteer.ViewHolder> {
    ...
    public NavMCAMBAAdapteer(List<AdmissionStaffData> list, Context context, String category) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        ...
        return new NavMCAMBAAdapteer.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull NavMCAMBAAdapteer.ViewHolder holder, int position) {
