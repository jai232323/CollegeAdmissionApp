...
public class NavMEAdapter extends RecyclerView.Adapter<NavMEAdapter.ViewHolder> {

    private List<AdmissionStaffData> list;
    private Context context;
    private String category;

    public NavMEAdapter(List<AdmissionStaffData> list, Context context, String category) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        ...
        return new NavMEAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull NavMEAdapter.ViewHolder holder, int position) {
