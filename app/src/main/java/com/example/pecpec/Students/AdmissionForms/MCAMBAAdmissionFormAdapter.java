...
public class MCAMBAAdmissionFormAdapter extends RecyclerView.Adapter<MCAMBAAdmissionFormAdapter.ViewHolder> {

    private List<AdmissionStaffData> list;
    private Context context;
    private String course;

    public MCAMBAAdmissionFormAdapter(List<AdmissionStaffData> list, Context context, String course) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.mcamba_admissionforms_adapter,parent,false);

        return new MCAMBAAdmissionFormAdapter.ViewHolder(view);
    }
