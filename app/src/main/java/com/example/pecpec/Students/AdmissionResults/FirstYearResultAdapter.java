...
public class FirstYearResultAdapter extends RecyclerView.Adapter<FirstYearResultAdapter.ViewHolder> {
    ...
    public FirstYearResultAdapter(List<AdmissionStaffData> list, Context context, String category) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new FirstYearResultAdapter.ViewHolder(view);
    }
